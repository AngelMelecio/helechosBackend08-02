...
from apps.Registros.api import registro_api_view,registro_detail_api_view,regitros_by_idProduccion,produccion_por_modelo_y_empleado,produccion_por_maquina_y_turno
urlpatterns = [
    ...
    path('produccion_por_maquina_y_turno/<str:fechaInicio>/<str:fechaFin>/<str:departamento>', produccion_por_maquina_y_turno, name='produccion_por_maquina_y_turno'),
]